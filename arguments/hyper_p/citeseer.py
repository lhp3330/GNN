...
def parse_arguments():
    ...
    # optimization
    parser.add_argument("--max_epochs", dest="max_epochs", default=400, type=int)
    ...
    parser.add_argument("--act_num_layers", dest="act_num_layers", default=3, type=int)
    ...
    # cluster loss
    parser.add_argument('--warmup_epochs', dest='warmup_epochs', type=int, default=20)
    parser.add_argument('--reg_weight', dest='reg_weight', type=float, default=0.002)
    parser.add_argument('--cluster_weight', dest='cluster_weight', type=float, default=0.1)
