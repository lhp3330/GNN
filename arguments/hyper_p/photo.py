...
def parse_arguments():
    ...
    parser.add_argument("--dataset_name", dest="dataset_name", default='Photo')
    ...
    # optimization
    parser.add_argument("--max_epochs", dest="max_epochs", default=2000, type=int)
    parser.add_argument("--lr", dest="lr", default=5e-3, type=float)
    parser.add_argument("--weight_decay", dest="weight_decay", default=5e-6, type=float)
    ...
    # cluster loss
    parser.add_argument('--warmup_epochs', dest='warmup_epochs', type=int, default=50)
    parser.add_argument('--reg_weight', dest='reg_weight', type=float, default=0.005)
    parser.add_argument('--cluster_weight', dest='cluster_weight', type=float, default=0.001)
    #   cluster_weight = 0.1¨C0.5
    #   reg_weight = 0.01¨C0.1
    #   warmup_epochs = 10¨C20
